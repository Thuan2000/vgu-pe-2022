  ...
  return (
    <div className="space-y-2 mx-5">
        ...
        <div className="border border-gray-100 rounded-sm fic justify-between p-10 cursor-pointer grid grid-cols-2 justify-between">
            ...
            <p className="font-semibold text-semibold text-2xl mb-2">{t("seller-account")} </p>

            <p className="font-semibold text-semibold text-2xl mb-2 col-end-3 flex justify-end">/{t("year-label")} </p>
            
            <p className="text-lg mb-2 col-start-1">{t("setting-remaining-end")}</p>
            <p className="text-lg text-gray-300 col-start-1">{t("setting-trancation-id-label")}: </p>
        ...
        <div className="border border-gray-100 rounded-sm fic justify-between p-5 cursor-pointer grid grid-cols-4 justify-between">
            ...
            <p className="font-semibold text-semibold text-lg mx-10">Seller Account</p>
            <p className="text-lg mx-10">ASd199932103</p>
            <p className="font-semibold text-semibold text-lg mx-14">VND 100.000.000</p>
        ...
        <Typography
            ...
            variant="bigTitle"
        />
        <p className="font-semibold text-semibold text-gray-300 text-lg">{t("setting-lang-title")}</p>
