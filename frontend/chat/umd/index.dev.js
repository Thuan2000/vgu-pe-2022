...
/* harmony export */   "IS_WSS": () => (/* binding */ IS_WSS)
/* harmony export */ });
const SERVER_URL = "chat.dev.sdconnect.vn";
const DOMAIN_NAME = "sdconnect.vn";
const SDCONNECT_URL = "https://dev.sdconnect.vn";
const APP_TITLE = "SDConnect Chat";
const IS_WSS = true;
...
const APP_NAME = "SDConnect Chat (v".concat(_version_js__WEBPACK_IMPORTED_MODULE_1__.PACKAGE_VERSION, ")");
...
const LINK_CONTACT_US = "email:hello@sdconnect.vn";
const LINK_PRIVACY_POLICY = "https://sdconnect.vn/privacy";
const LINK_TERMS_OF_SERVICE = "https://sdconnect.vn/terms";
...
class CookieUtil {
  ...
  static getObject(key) {
    const value = js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].get(key, getDomain());
  ...
  static removeItem(key) {
    js_cookie__WEBPACK_IMPORTED_MODULE_0__["default"].remove(key, getDomain());
  }
...
function updateFavicon(count) {
  ...
  document.title = "".concat(count > 0 ? "(".concat(count, ")") : "", " ").concat(_env__WEBPACK_IMPORTED_MODULE_1__.APP_TITLE);
}
...
/* harmony import */ var _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../lib/cookie-util.js */ "./src/lib/cookie-util.js");
...
class CreateAccountView extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  constructor(props) {
    ...
    this.state = {
      ...
      imageDataUrl: null,
      errorCleared: false,
      saveToken: _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_5__["default"].getObject("keep-logged-in")
    };
  ...
  handleToggleSaveToken() {
    _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_5__["default"].setObject("keep-logged-in", !this.state.saveToken);
    this.setState({
...
const LoginView = () => {
  ...
  }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
    id: "loading-title",
    defaultMessage: [{
      "type": 0,
      "value": "Loading..."
...
/* harmony import */ var tinode_sdk__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! tinode-sdk */ "tinode-sdk");
/* harmony import */ var tinode_sdk__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(tinode_sdk__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _env__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../.env */ "./.env.js");
...
class LogoView extends (react__WEBPACK_IMPORTED_MODULE_0___default().PureComponent) {
  render() {
    return react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      ...
      href: _env__WEBPACK_IMPORTED_MODULE_3__.SDCONNECT_URL
    }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement("img", {
      id: "logo",
      alt: "logo",
      src: "img/logo.svg"
    }), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2", null, "Sdconnect")), react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      style: {
        marginTop: 5
      }
    }, react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_intl__WEBPACK_IMPORTED_MODULE_1__.FormattedMessage, {
...
/* harmony import */ var _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../lib/cookie-util.js */ "./src/lib/cookie-util.js");
...
class TinodeWeb extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component) {
  ...
  getBlankState() {
    const settings = _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("settings") || {};
    const persist = !!_lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("keep-logged-in");
    return {
      connected: false,
      ready: false,
      autoLogin: false,
      transport: settings.transport || null,
      serverAddress: (0,_lib_host_name_js__WEBPACK_IMPORTED_MODULE_14__.detectServerAddress)(),
      ...
      firebaseToken: persist ? _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("firebase-token") : null,
  ...
  componentDidMount() {
    ...
    new Promise((resolve, reject) => {
      ...
      const token = this.state.persist ? _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject(_lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__.AUTH_TOKEN_NAME) : undefined;
  ...
  handlePersistenceChange(persist) {
    if (persist) {
      this.tinode.initStorage().then(() => {
        _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].setObject("keep-logged-in", true);
        this.setState({
          persist: true
        });
      });
      ...
      this.tinode.clearStorage().then(() => {
        _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].setObject("keep-logged-in", false);
        this.setState({
          persist: false
        });
      });
  ...
  doLogin(login, password, cred) {
    ...
    if (promise) {
      promise.then(ctrl => {
        ...
        this.handleError(err.message, "err");
        localStorage.removeItem(_lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__.AUTH_TOKEN_NAME);
        _lib_navigation_js__WEBPACK_IMPORTED_MODULE_16__["default"].navigateTo("");
      });
    } else {
      _lib_navigation_js__WEBPACK_IMPORTED_MODULE_16__["default"].navigateTo("");
  ...
  handleLoginSuccessful() {
    this.handleError();
    _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].setObject(_lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__.AUTH_TOKEN_NAME, this.tinode.getAuthToken());
  ...
  handleGlobalSettings(settings) {
    ...
    this.tinode = TinodeWeb.tnSetup(serverAddress, transport, this.props.intl.locale, _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("keep-logged-in"));
    this.tinode.onConnect = this.handleConnected;
    this.tinode.onDisconnect = this.handleDisconnect;
    this.tinode.onAutoreconnectIteration = this.handleAutoreconnectIteration;
    this.setState({
    ...
    _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].setObject("settings", {
      serverAddress: serverAddress,
      transport: transport
    });
    ...
    if (enabled) {
      if (!this.state.firebaseToken) {
        ...
        fcm.then(() => {
          ...
          _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].updateObject("settings", {
            desktopAlerts: false
          });
        });
      } else {
        ...
        if (_lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("keep-logged-in")) {
          _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].updateObject("settings", {
            desktopAlerts: true
          });
        }
  ...
  requestPushToken() {
    this.fbPush.getToken().then(refreshedToken => {
      ...
      if (refreshedToken != this.state.firebaseToken) {
        ...
        if (persist) {
          _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].setObject("firebase-token", refreshedToken);
        }
      }
  ...
  handleLogout() {
    ...
    this.tinode = TinodeWeb.tnSetup(this.state.serverAddress, this.state.transport, this.props.intl.locale, _lib_cookie_util_js__WEBPACK_IMPORTED_MODULE_15__["default"].getObject("keep-logged-in"));
    this.tinode.onConnect = this.handleConnected;
    this.tinode.onDisconnect = this.handleDisconnect;
    this.tinode.onAutoreconnectIteration = this.handleAutoreconnectIteration;
    _lib_navigation_js__WEBPACK_IMPORTED_MODULE_16__["default"].navigateTo("");
