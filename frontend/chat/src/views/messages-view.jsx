...
import { SDCONNECT_URL } from "../../.env.js";
      ...
      fileToBase64(
        ...
        (mime, bits, fname) => {
          this.props.sendMessage(
            Drafty.attachFile(null, { mime: mime, data: bits, filename: fname })
          );
        },
        this.props.onError
      );
        ...
        topic.messages((msg, prev, next, i) => {
          ...
          messageNodes.push(
            <ChatMessage
              ...
              showContextMenu={
                this.state.channel ? false : this.handleShowContextMenuMessage
              }
          ...
          <>
            <div id="topic-caption-panel" className="caption-panel">
              ...
              <div id="topic-title-group">
                <a href={sluggedUrl} target="_blank">
                  <div
                    id="topic-title"
                    style={{ fontSize: "11pt" }}
                ...
                <div id="topic-last-seen" style={{ fontSize: "10pt" }}>
                  {lastSeen}
                </div>
              </div>
              {groupTopic ? (
                <GroupSubs subscribers={this.state.onlineSubs} />
              ) : (
                <div id="topic-users" />
              )}
              <div>
